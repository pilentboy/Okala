...
export default function Offers() {
  return (
    <div className="w-full overflow-y-hidden h-[400px] px-5 gap-5 my-10 flex flex-col items-end">
      {/* top */}
          ...
          <div className="flex w-full mb-4 gap-4">
            {Array(10)
              ...
              .map((item, index) => (
                <div
                  key={index}
                  className="flex flex-col  rounded-2xl items-center py-2  h-[170px] w-[100px]  flex-shrink-0 justify-between bg-white"
                >
